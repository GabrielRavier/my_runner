...
SOURCE_FILES := main game/change_music game/create/create game/create/window game/destroy game/draw/draw game/handle/key game/main_loop game/player game/object/building_rect game/object_vector game/set/mode game/update/update parse_argv random
